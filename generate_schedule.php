...
$courseTypes = range(1, 5); // Assuming course types are 1-5
$instructors = range(1, 20); // Assuming instructor IDs are 1-20
$branches = range(1, 5); // Assuming branch IDs are 1-5
